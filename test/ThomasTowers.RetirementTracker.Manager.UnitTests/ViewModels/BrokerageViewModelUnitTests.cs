...
{
    public class BrokerageViewModelUnitTests
    {
        [Fact]
        public void TestValidation()
        {
            var model = new BrokerageViewModel();
            ...
            Assert.Equal(nameof(BrokerageViewModel.Name), args[0].PropertyName);
            ...
            Assert.Equal(nameof(BrokerageViewModel.Name), args[2].PropertyName);
